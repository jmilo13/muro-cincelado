...
- Finalmente, la comunicación debe estar presente en todo momento. No sirve de nada tener claro lo que se desea si no se dice, así como aquello con lo que no se está de acuerdo. Los [celos](http://localhost/muro_cincelado_final/celos/) pueden aparecer en cualquier instante y para poder transitarlos de la mejor forma se requiere de un diálogo sincero y abierto. Los problemas requieren ser abordados en conjunto. Por ende, la apertura y comprensión por parte de las otras personas debe estar presente.
