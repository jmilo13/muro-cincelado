...
import '../assets/styles/Autor.css'

const Autor = () => {
        return (
            <main className="main"> 
                <article className="autor">
                    <img src={profile} alt="Camilo Gonzalez" className="autor__image"/>
                    ...
                    <div className="autor__description">
                        ...
                        <p>
                        <Link to="/modalidad-de-intervencion">Aqui </Link>puedes consultar la modalidad de atención y tarifas. 
